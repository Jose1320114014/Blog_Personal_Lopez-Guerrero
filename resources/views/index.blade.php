...
-->
    ...
    <!-- ***** Header Area Start ***** -->
    <header class="header-area header-sticky" style=" background-color: #1b1e21 ">
        <div class="container" style=" background-color: #1b1e21 ">
            <div class="row"style=" background-color: #1b1e21 ">
                <div class="col-12"style=" background-color: #1b1e21 ">
                    <nav class="main-nav" style="background: #1b1e21">
                        <!-- ***** Logo Start ***** -->
                    <a href="{{route('index')}}" class="logo">ムYharon<em>Smokeム</em></a>
                        <!-- ***** Logo End ***** -->
    ...
    <div class="main-banner" id="top">
        <video autoplay muted loop id="bg-video">
            <source src="/images/Death_Sworn_Zed_Animation_(Wallpaper_Engine).mp4" type="video/mp4" />
        </video>

        <div class="video-overlay header-text">
            <div class="caption">
                <h6>Preparate para una lectura que obviamente no es nada aburrida (si lo es)</h6>
